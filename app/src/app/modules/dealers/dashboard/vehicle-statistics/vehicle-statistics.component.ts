...
import { Filters } from 'src/app/modules/admin/dashboard/dashboard.model';
...
export class VehicleStatisticsComponent implements OnInit {
  ...
  constructor(private dashboardService: DealerDashboardService, private translate: TranslateService,
  ...
  createChart(chartData: any = []){
    let data: any,
    options: any,
    ctx: any = document.getElementById('dealerVehicleStatsChart') as HTMLElement;
    let labels: any = [];
    ...
    const customTooltips = (context: any) => {
      ...
      let tooltipEl: any = document.getElementById('dealer-vehicles-tooltip');
      if (tooltipEl) tooltipEl.remove();
      if (!tooltipEl) {
        tooltipEl = document.createElement('div');
        tooltipEl.id = 'dealer-vehicles-tooltip';
        ...
        tooltipEl.innerHTML = `<ul style="width:100%;padding: 8px 0;">
                    <li style="display: flex;align-items: center;justify-content: space-between;padding: 0 10px;line-height: 20px;">
                        <div class="title" style="display: flex;align-items: center;">
                            ...
                            <span style="font-size: 12px;color: #3B1144;font-weight: 500;"><span style="font-size: 12px;font-weight:600">`+vehicleListed+`</span> Vehicle Listed</span>
                        </div>
                    </li>
                    <li style="display: flex;align-items: center;justify-content: space-between;padding: 0 10px;line-height: 20px;">
                        <div class="title" style="display: flex;align-items: center;">
                            ...
                            <span style="font-size: 12px;color: #3B1144;font-weight: 500;"><span style="font-size: 12px;font-weight:600">`+vehicleSold+`</span> Vehicle Sold</span>
                        </div>
                    </li>
                  </ul>`;
